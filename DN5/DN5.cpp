...
// Gauss-Seidel methoda
#pragma omp parallel for
for (int ii = 0; ii < num_iterations; ii++) {
  // ... Implement the Gauss-Seidel iteration here ...
}
...
std::cout << "Time of Gauss-Seidel method: " << time_duration.count() << " seconds" << std::endl;

// Find and print the maximum temperature
double max_T = *max_element(T.begin(), T.end());
std::cout << "Max. temperature: " << max_T << " degree C." << std::endl;
 // konec
